...
public class Server {
	...
	private static List<JuegoSieteYMedio> listaJuegos;
	private static List<Socket> listaSockets;
	private static boolean close;
	
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		int puerto = 2001;
		listaJuegos = new ArrayList<JuegoSieteYMedio>();
		...
		do{
			...
			listaJuegos.add(new JuegoSieteYMedio(new Game(), listaSockets.remove(0)));
